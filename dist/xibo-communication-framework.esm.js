...
var Xmr = /*#__PURE__*/function () {
  function Xmr(channel) {
    ...
    this.lastMessageAt = DateTime.now().minus({
      year: 1
    });
  }
  return _createClass(Xmr, [{
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 34:
              ...
              this.socket.addEventListener('message', function (event) {
                console.debug(event);
                _this2.lastMessageAt = DateTime.now();
    ...
    value: function isActive() {
      ...
      return this.isConnected && this.lastMessageAt > DateTime.now().minus({
        minute: 15
      });
    }
  }]);
...
export { Xmr };
//# sourceMappingURL=xibo-communication-framework.esm.js.map
