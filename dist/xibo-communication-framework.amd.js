define(['exports', 'luxon'], (function (exports, luxon) { 'use strict';
  ...
  var Xmr = /*#__PURE__*/function () {
    function Xmr(channel) {
      _classCallCheck(this, Xmr);
      _defineProperty(this, "emitter", void 0);
      _defineProperty(this, "url", void 0);
      _defineProperty(this, "cmsKey", void 0);
      ...
      this.lastMessageAt = luxon.DateTime.now().minus({
        year: 1
      });
    }
    return _createClass(Xmr, [{
      key: "on",
              ...
              case 0:
                this.interval = setInterval(function () {
                  if (_this.isConnectionWanted && !_this.isActive()) {
                    ...
                    // Call start again
                    _this.start(_this.url || 'DISABLED', _this.cmsKey || 'n/a');
                  }
                }, 60000);
              case 1:
              case "end":
            ...
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 34:
                ...
                this.socket.addEventListener('close', function (event) {
                  ...
                  _this2.emitter.emit('disconnected');
                });
                /**
                ...
                this.socket.addEventListener('message', function (event) {
                  console.debug(event);
                  _this2.lastMessageAt = luxon.DateTime.now();
                  _this2.emitter.emit('statusChange', _this2.lastMessageAt.toISO() || '');
      ...
      value: function isActive() {
        ...
        return this.isConnected && this.lastMessageAt > luxon.DateTime.now().minus({
          minute: 15
        });
      }
    }]);
...
//# sourceMappingURL=xibo-communication-framework.amd.js.map
